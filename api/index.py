...
def home():
    ...
    data = {
        ...
        'metadeskripsi': 'Sarjana.web.id menyajikan informasi terkini dan akurat. Temukan berita terbaru seputar politik, ekonomi, '\
...
def cataogory(category):
    ...
    data = {
        ...
        'metadeskripsi': f'Sarjana.web.id menyajikan informasi terkini dan akurat dalam kategori {category}. Temukan berita terbaru seputar {category} dan topik lainnya. Update setiap hari dengan konten berkualitas.'
    }
